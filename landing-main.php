...
<section class="clean-block clean-hero" style="background-image:url('<?php echo get_template_directory_uri(). '/' ?>assets/img/banner.png');color:transparent;">
        ...
        <section class="clean-block clean-form dark">
            <div class="container">
                ...
                <form method="post" target="_self" id="contactForm">
                    <div class="alert alert-success d-none" role="alert" id="contactSuccessAlert"><span><strong>Gracias por su correo!</strong></span></div>
                    <div class="form-group"><label>Nombre</label><input class="form-control" type="text" name="nombre"></div>
                    <div class="form-group"><label>Empresa</label><input class="form-control" type="text" name="empresa"></div>
                    <div class="form-group"><label>Email</label><input class="form-control" type="text" name="email"></div>
                    <div class="form-group"><label>Mensaje</label><textarea class="form-control" name="mensaje"></textarea></div>
                    <div class="form-group"><button class="btn btn-primary btn-block" type="submit" id="contactSubmitButton">ENVIAR</button></div>
                </form>
            </div>
        </section>
        <section>
